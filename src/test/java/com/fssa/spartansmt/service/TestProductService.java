...
class TestProductService {
	...
	public static List<Product> listOfProduct() {
		...
		productList.add(new Product("Mens Air Zoom Vomero 15 Running Shoe", 10009.53, "https://iili.io/HkeiZmb.webp", 1, LocalDate.now()));
		productList.add(new Product("Men's Ultra Light Running <br>and Training Shoes", 4999, "https://iili.io/HkeiQku.webp", 1, LocalDate.now()));
		productList.add(new Product("Men's Running Shoe<br>Bacca Bucci", 5230, "https://iili.io/HkeiDIj.webp", 1, LocalDate.now()));
		productList.add(new Product("Mens Slip-on Premium Comfy-fit Sneaker", 4536.34, "https://iili.io/HkeiL7e.webp", 1, LocalDate.now()));
		productList.add(new Product("Men's Wonder-13 Sports Running Shoes", 5484.92, "https://iili.io/Hkeis29.webp", 1, LocalDate.now()));
		productList.add(new Product("Mens Ultimate Ease Range Walking Shoe", 3299, "https://iili.io/Hkeibhx.webp", 1, LocalDate.now()));
